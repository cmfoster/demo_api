...
set :bundle_cmd, "/home/n0de/.rvm/gems/ruby-2.0.0-p353@global/bin/bundle"
set :bundle_dir, "/home/n0de/.rvm/gems/ruby-2.0.0-p353/gems"
set :rvm_ruby_string, :local
set :rack_env, :production

#general info
set :user, 'n0de'
set :domain, 'fmbuzz.com'
set :applicationdir, "/var/www/demo_api"
set :scm, 'git'
set :application, "demo_api"
set :repository,  "git@github.com:cmfoster/demo_api.git"
